...
internal class AXB35 : ISuperIO, INamedIO
{
    public Chip Chip => Chip.IT5570E;
    ...
    public void SetControl(int index, byte? value)
    {
        ...
        {
            // Set auto
            WindowsEmbeddedControllerIO.Instance.WriteSingle((byte)_registers[index * 2], valBase, 5000);
        }
        else
        {
